        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" id="editCategoryForm" action="{{ route('admin.faq-categories.update', $faqCategory->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="categoryName" name="name" type="text"
                                        placeholder="Enter category name" value="{{ $faqCategory->name }}" />
